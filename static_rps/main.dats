...
implement main0 () = {
  ...
  val () = println! (even_d, " is even between ", win_d, " and ", paper_d, ".")
  ...
  val () = println! (even_s, " is even between ", win_s, " and ", paper_s, ".")
      // => Rock is even between Scissors and Paper.
  (* Proofs *)
  val paper_p = p_rps_t()
  ...
  val () = println! (even_p, " is even between ", win_p, " and ", paper_p, ".")
      // => Rock is even between Scissors and Paper.
}
